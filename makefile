...
UNICFLAGS=${MG} -Wno-deprecated ${OSFLAGS} $(INC_UNIFRAME) ${X86_64DEF}

###############################################################################
# Set all Basic libs  here
#   กใจน??กง ????????LIB??จจ???????? UniFrame LIB??จจ????
###############################################################################
# database LIB
...
SRC_C_KERNEL=\
	...
	kernel/kernalthread.C  kernel/taskselector.C\
	kernel/timer.C    kernel/timerqueue.C  framemng.C
