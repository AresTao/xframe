...
///
///@description common const field define
///
...
const INT INFO_BUF_SIZE          = 8096;///
const INT INFO_PRE_SIZE          = 96;  ///
...
const I32  MAX_MSG_BUF_SIZE      = MaxMsgLength; //80K
